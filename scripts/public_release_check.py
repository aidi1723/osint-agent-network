...
SELF_SCAN_ALLOWLIST: dict[tuple[str, str, str], int] = {
    ...
    for entry in (
        ...
        ("backend/tests/test_safe_http.py", "PUBLIC_PRIVATE_NETWORK", "6fc141f941ee68769202f34eb21c2970e08f5579520180a9dc9023e960837c0c"),
        ("backend/tests/test_safe_http.py", "PUBLIC_PRIVATE_NETWORK", "960be1be2033fa674bf30ae481d8ba3a0b7720c890ea662a656314bd81786644"),
        ("backend/tests/test_safe_http.py", "PUBLIC_PRIVATE_NETWORK", "ee41e8971e557e719321a7d6ea5695f150a5ad885742ed7b99f8f2a87d37f90b"),
